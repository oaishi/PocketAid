...
public class HolderOfInshot extends Fragment {
    ...
    protected CustomAdapterInshot mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_holder_of_aid_list, container, false);
        mRecyclerView = (RecyclerView) rootView.findViewById(R.id.my_recycle_view_list);
        rainbow =(container.getContext()).getResources().getIntArray(R.array.array1);
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        savedInstanceState.putParcelableArrayList("arraylist",mDataSet);
