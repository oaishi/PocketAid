...
public class MyData {
    ...
    static Integer[] drawableArray = {R.drawable.aid, R.drawable.pocha, R.drawable.aid,
             R.drawable.pocha, R.drawable.aid, R.drawable.pocha,
            R.drawable.aid, R.drawable.pocha, R.drawable.aid,R.drawable.pocha,R.drawable.aid};
